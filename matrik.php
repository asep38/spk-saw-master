...
<body>
  ...
  <div class="modal modal-backdrop fade show text-left" id="editModal" tabindex="-1" aria-labelledby="editModalLabel"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editForm" onsubmit="updateValues()">
            ...
            <?php for ($i = 1; $i <= 20; $i++) { ?>
              <div class="form-group">
                <label for="editC<?php echo $i; ?>">Nilai C
                  <?php echo $i; ?>:
                </label>
                <input type="number" max="4" min="1" class="form-control" id="editC<?php echo $i; ?>"
                  name="editC<?php echo $i; ?>">
              </div>
            <?php } ?>
            <div class="modal-footer">
